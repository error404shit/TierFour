<article id="post-<?php the_ID(); ?>" <?php post_class('recent-post-2'); ?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="Blog">
    <div class="col-xl-12">
    	<figure class="article-thumb" itemprop="image" itemscope itemType="http://schema.org/ImageObject">
            <a href="<?php the_permalink(); ?>" itemprop="url">
                ...
                <img class="recent-post-2-img" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" onerror="javascript:this.src='<?php echo get_template_directory_uri() . "/assets/img/No_image.png"; ?>'" itemprop="image"  title="<?php the_title(); ?>" alt="<?php the_title(); ?>">
            </a>
        </figure>
    </div>
    <div class="col-xl-12">
    ...
    <div class="recent-post-content">
        <?php echo "<p class='lead' itemprop='articleBody'>".excerpt(30)."</p>"; ?>
