<article id="post-<?php the_ID() ?>" <?php post_class('p-0 featured-post') ?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="Blog">
	<div class="col-12 p-0">
		<figure class="article-cat-page-thumb ml-0 mr-0 mt-0 mb-5" itemprop="image" itemscope itemType="http://schema.org/ImageObject">
	   		<a href="<?php the_permalink(); ?>" itemprop="url">
	      		<link itemprop="url" href="<?php the_post_thumbnail_url(); ?>">
	         	<img class="responsive-img featured-img" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" onerror="javascript:this.src='<?php echo get_template_directory_uri() . "/assets/img/No_image.png"; ?>'" itemprop="image"  title="<?php the_title(); ?>" alt="<?php the_title(); ?>">
	        </a>
		</figure>
		<header class="featured-header">
			...
			<div class="excerpt-text-size-small date-item  cats-top">
				...
				<a href="<?php echo get_month_link( $archive_year, $archive_month ); ?>"><?php the_time('F Y'); ?></a>
<!-- 			</div>
			<div class="cats-top"> -->
			<?php
			...
			<?php echo "<p class='feat-desc lead text-white' itemprop='articleBody'>".excerpt(10)."</p>"; ?>
		</header>
	</div>
</article>